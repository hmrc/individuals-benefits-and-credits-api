...
trait ScopesConfigHelper {
  ...
  val mockScopesConfig = Configuration(
    ...
    (s"api-config.endpoints.benefits-and-credits.endpoint",
      "individuals/benefits-and-credits?matchId=<matchId>{&fromDate,toDate}>"),
    (s"api-config.endpoints.benefits-and-credits.title", "Get an individual's benefits and credits data"),
    (s"api-config.endpoints.benefits-and-credits.fields.A", "applications/id"),
    (s"api-config.endpoints.benefits-and-credits.fields.B", "applications/awards/totalEntitlement"),
    (s"api-config.endpoints.benefits-and-credits.fields.C", "applications/awards/payProfCalcDate"),
